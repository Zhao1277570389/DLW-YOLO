...
from ultralytics.nn.SOCA import SOCA
...
from ultralytics.nn.v9 import SPPELAN,ADown
from ultralytics.nn.Dysample import DySample
from ultralytics.nn.DilateFormerAT import DilateBlock,C2f_DilateBlock
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, GGhostRegNet, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x, RepC3, SEAttention,ContextAggregation, BoTNet, CBAM,LightConv,RepConv, SpatialAttention,Involution, CARAFE, VoVGSCSP, VoVGSCSPC,GSConv,HorBlock, SwinTransformer, MobileOneBlock,MobileViT,MobileViTBlock,MV2Block,CondConv2D,MBConv,FusedMBConv,stem,RepViTblock,DSConv,DySnakeConv,C2f_DySnakeConv,Bottleneck_DySnakeConv,C2f_LSKA_Attention,LSKA_Attention,LSKA,EMA_attention,ODConv,AKConv,SPPELAN,ADown,DilateBlock,C2f_DilateBlock,CAFMAttention,MSFN,MDCR,PPA,DASI,DualConv):
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3,BoTNet,C2f_LSKA_Attention,NAM):
            ...
            c1, c2 = ch[f], args[0]
            if c2 != torch.NoneType:  # if not outputss
                c2 = make_divisible(c2 * width, 8)
            args = [c1, c2, *args[1:]]
